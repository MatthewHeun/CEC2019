...
% what are the social and economic ``costs'' or implications of remaining with the current system?
...
long-haul trucking and goods distribution. % wait, we said personal transport?
...
Thus how the proposal is evaluated will involve tradeoffs among environmental, economic, and social factors.
Below we evaluate banning personal vehicles that consume fossil fuels 
from the perspectives of the Christian worldviews outlined in section \ref{sec:environmental}.
