...
\begin{itemize}
 ...
 % DONE  \item Delete Section 4 (JvA) % DONE
...
in how it operates.
% add in theological/biblical justification for each view.
...
\begin{enumerate}
  ...
  \item The transportation system (all modes, not just personal transportation vehicles) 
		...
		It is proposed that all air travel be banned.
		...
		\begin{itemize}
		  ...
		  \item In developing policies regarding air travel, whose opinion should we respect? 
  		  ...
  		  \item This policy question gets at several “axes” of tradeoffs and decision-making:
  ...
  \item Any policy-driven change, 
		...
		\begin{itemize}
		  ...
		  \item Should we be this mathematical in our decision making?
