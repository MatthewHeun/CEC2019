...
Evaluating the proposed ban on personal transport vehicles
will involve tradeoffs among environmental, economic, and social factors.
Decisions on those tradeoffs are necessarily informed by 
worldviews. 
Below we consider how the Christian worldviews briefly described
in Sections~\ref{sec:environmental}, \ref{sec:economic}, and~\ref{sec:social}
would respond to the proposed banning of personal vehicles that consume fossil fuels.
We use the proposed ban to explore how Christian worldviews matter 
when sustainability issues are at stake.
**** This could be a thesis sentence. Move forward?  Or at least hint at this direction above? ****
