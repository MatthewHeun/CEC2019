...
\caption{Axes for individualistic and collective views on economic and social issues.}
\label{fig:axes}
\end{figure}
...
\caption{Table for individualistic and collective views on economic and social issues.}
\label{fig:table}
\end{figure}
